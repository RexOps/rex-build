...
task "test", group => "test", sub {
  ...
  ok(is_file("/users/bar/.ssh/authorized_keys"), "user bar have an authorized_keys files");
  ...
  ok(is_file("/users/horse/.ssh/authorized_keys"), "horse does have an authorized_keys");
