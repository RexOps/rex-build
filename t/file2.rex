...
task test => group => test => sub {
   ...
   upload "t/file2/files/upload.txt", "$base_dir";
   ...
   upload "t/file2/files/upload.txt", "$base_dir/foo.txt";
   ...
   file "$base_dir/file-upload.txt",
      source => "t/file2/files/upload.txt";
   ...
   file "$base_dir/template-file.txt",
      content => template("t/file2/templates/templ.txt");
